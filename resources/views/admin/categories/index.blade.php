    ...
    @if(session('success'))
        <div class="bg-green-50 border-l-4 border-green-400 p-4 mb-6 rounded-r-lg" role="alert">
            <div class="flex items-center justify-between">
                ...
                <button type="button" class="text-green-400 hover:text-green-600 focus:outline-none focus:text-green-600" onclick="this.parentElement.parentElement.remove()">
    ...
    @if(session('error'))
        <div class="bg-red-50 border-l-4 border-red-400 p-4 mb-6 rounded-r-lg" role="alert">
            <div class="flex items-center justify-between">
                ...
                <button type="button" class="text-red-400 hover:text-red-600 focus:outline-none focus:text-red-600" onclick="this.parentElement.parentElement.remove()">
                    <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                    </svg>
                </button>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
            <div>
                ...
                <p class="mt-2 text-sm text-gray-600">Organize and manage product categories</p>
            </div>
            ...
            <div class="bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-purple-100 text-sm">Manage your product categories</p>
                    </div>
                    <div class="bg-white bg-opacity-20 rounded-lg p-3 text-center backdrop-blur-sm">
                        ...
                        <div class="text-xs text-purple-100 font-medium">Total</div>
                    </div>
                </div>
            </div>
            ...
            <div class="p-6">
                                                ...
                                                <div class="flex-shrink-0 h-10 w-10">
                                                    @if($category->featured_img)
                                                        <img class="h-10 w-10 rounded-lg object-cover shadow-sm"
                                                             src={{ asset('storage/' . $category->featured_img)  }}
                ...
                @else
                    ...
                    <div class="text-center py-12">
                        ...
                        <p class="text-gray-500 mb-6">Get started by creating your first product category.</p>
                        <a href="{{ route('admin.categories.create') }}"
